...
class travel:
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','North Nagpur','South Nagpur','West Nagpur','East Nagpur')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','North Nagpur','South Nagpur','West Nagpur','East Nagpur')
        self.cboDrop.current(0)
    ...
    #==========================================================Cabselect=======================================================================
        ...
        self.chkStandard=Radiobutton(Book_Frame,text="Standard Ola",value=1,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        ...
        self.chkFordGalaxyd=Radiobutton(Book_Frame,text="Premium Ola",value=2,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        ...
        self.chkFordMondeo = Radiobutton(Book_Frame,text="Gold Ola",value=3,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=2, column=0)
